...
public class ItemFragment2 extends Fragment {
    ...
    private int[] imageArray = new int[]{R.drawable.image_full, R.drawable.ic_launcher_background,
            R.drawable.image_full, R.drawable.ic_launcher_background, R.drawable.image_full,
            R.drawable.ic_launcher_background, R.drawable.image_full, R.drawable.ic_launcher_background,
            R.drawable.image_full, R.drawable.ic_launcher_background};

    public static Fragment newInstance(NewsFeedWhiteActivity context, int pos, float scale) {
        Bundle b = new Bundle();
